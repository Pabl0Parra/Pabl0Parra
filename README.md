...
- :handshake: Collaborating on open source project [KingsLeague](https://github.com/midudev/kings-league-project), where we are building their API from scratch as well as redesigning the official website with [Astro](https://astro.build/) framework.
